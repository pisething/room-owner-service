...
public record RoomParsedRow(
    ...
    public static final Comparator<RoomParsedRow> BY_OWNER_THEN_NAME =
            Comparator.comparing(RoomParsedRow::ownerId, Comparator.nullsLast(String::compareTo))
                .thenComparing(RoomParsedRow::name, Comparator.nullsLast(String::compareTo));
}
